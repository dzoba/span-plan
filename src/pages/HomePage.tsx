    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <header className="px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <h1 className="text-2xl font-bold text-gray-900">SpanPlan</h1>
        ...
        <div className="max-w-3xl mx-auto mt-24">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-medium text-gray-900">Create a timeline</h4>
                <p className="text-gray-600">Click the button above to create a new timeline. No sign-up required.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center flex-shrink-0 text-sm font-medium">
              ...
              <div>
                <h4 className="font-medium text-gray-900">Add items to rows</h4>
                <p className="text-gray-600">Double-click on any row to add an item. Drag to move, resize edges to adjust duration.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center flex-shrink-0 text-sm font-medium">
              ...
              <div>
                ...
                <p className="text-gray-600">Copy the URL and share it with your team. They can view and edit in real-time.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="px-6 py-8 mt-20 border-t border-gray-200">
